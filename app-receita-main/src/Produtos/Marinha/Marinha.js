...
import { StyleSheet, Text, View, TouchableHighlight, Modal, Image, FlatList, ScrollView, SafeAreaView, TouchableOpacity, Platform } from 'react-native';
...
export default function Marinha({ navigation }) {
  ...
  const imagePick = async () => {
    ...
    if (!result.cancelled) {
      ...
      const refs = ref(storage, `Marinha/${timeimg}`);
