...
import { StyleSheet, Text, View, Image, FlatList, ScrollView, Platform, SafeAreaView, TouchableOpacity, Modal } from 'react-native';
...
export default function Vegetariano() {
  ...
  const imagePick = async () => {
    ...
    if (!result.cancelled) {
      ...
      const refs = ref(storage, `Vegetariano/${timeimg}`);
              ...
              <View style={styles.card}>
                <View style={styles.cardIMG}>
                  <TouchableOpacity style={{ alignItems: 'center', justifyContent: "center" }} onPress={() => { setVisivel(true) }}>
                    {/* <Image style={styles.imgCard} source={item.img}></Image> */}
